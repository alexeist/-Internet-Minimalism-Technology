<?php
/**********************************************************************************
Autopublicator v 1.35 Open. Автор Алекс Эйст 2021 aekap ITC Пожалуйста, не удаляйте эту строку комментария при использовании
* Этот скрипт может работать самостоятельно или совместно с Автопубликатором версии З.02-3.99, которые передают в запросе имя пользователя. 
...
* Каждый файл/extension или каталог может быть включен или нет, отключен или нет от публикации
...
//*****************    START TO CHANGE ******************************************//
//                   CONST                                                       //  
define ('APP_TITLE', "EXTERNET MINI. Autopublicator v 1.35 Open");               // измените значение этой постоянной согласно ваших нужд
define('USER_PASSWORD',                              19510104  );                // Капча - антиспам. Регулярно меняйте его.   
define('LNG_DEFAULT',                                      en  );                // измените значение языка по-умолчанию на ваш язык
...
$html = "<div class='container'> <div class='row'>";                         // первая строчка уже боди хтмл 
$us   = '';                                                                  // здесь будет вычисляться пароль
$usr  = '';                                                                  // здесь будет храниться юзернейм
$sub  = '';                                                                  // здесь лежит содержание Капчи
